...
for(l in 1:k){
  ...
  ggsave(paste('AE_K', 'Fold', as.character(l),'.tiff', sep = '_'), path = "./AE_K", width = 6, height = 4, device = "tiff", dpi = 300)
...
```{r}
ggsave(file = './aek_varimp1.png', width = 6, height = 4, dpi = 500)
```
...
# Compute n, ME, RMME and MEC for the testing phase
  ...
  ggsave(paste('AEK_F', 'Fold', as.character(l),'.tiff', sep = '_'), path = "./AE_P", width = 6, height = 4, device = "tiff", dpi = 600)
