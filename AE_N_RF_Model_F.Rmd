...
setwd("C:/Users/Eric_Asamoah/OneDrive - Wageningen University & Research/FERARI PhD 1 - Eric Asamoah/Academic/Data/Scripts/4_RF_models/Final_RF_Models/AE_N")
```
...
for(l in 1:k){
  ...
  pp <- ggplot(QRF_predictions, aes(observed,predicted)) +
    ...
    ggsave(paste('AE_N', 'Fold', as.character(l),'.tiff', sep = '_'), path = "C:/Users/Eric_Asamoah/OneDrive - Wageningen University & Research/FERARI PhD 1 - Eric Asamoah/Academic/Data/Scripts/4_RF_models/Final_RF_Models/AE_N", width = 6, height = 4, device = "tiff", dpi = 300)
...
```{r}
ggsave(file = 'C:/Users/Eric_Asamoah/OneDrive - Wageningen University & Research/FERARI PhD 1 - Eric Asamoah/Academic/Data/Scripts/4_RF_models/Final_RF_Models/AE_N/aen_varimp1.png', width = 6, height = 4, dpi = 500)
```
...
# Compute n, ME, RMME and MEC for the testing phase
  ...
  ggsave(paste('AEN_F', 'Fold', as.character(l),'.tiff', sep = '_'), path = "C:/Users/Eric_Asamoah/OneDrive - Wageningen University & Research/FERARI PhD 1 - Eric Asamoah/Academic/Data/Scripts/4_RF_models/Final_RF_Models/AE_N", width = 6, height = 4, device = "tiff", dpi = 300)
